...
// postRouter
  // .post('/post', middlewares.validateToken, postControllers.postPost)
// requisito 13, validateToken + getAllPost
  // .get('/post', middlewares.validateToken, postControllers.getAllPost)
// requisito 14, validateToken + getByIdPost
  // .get('/post/:id', middlewares.validateToken, postControllers.getByIdPost)
// requisito 15, validateToken + putByIdPost
  // .put('/post/:id', middlewares.validateToken, postControllers.putByIdPost)
